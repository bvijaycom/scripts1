...
echo " O/S Vendor    `lsb_release -i | cut -c 16-` <br>"
echo " O/S Release   `lsb_release -d | cut -c 13- `<br>"
...
echo "___________________________________________________________________________________<br>"
echo "<pre>`chkconfig --list|grep 3:on`</pre><br>"
